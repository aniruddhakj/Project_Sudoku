...
from BoardConstructor import ConstructGrid
...
class HomePage(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.titlelabel = Label(self, text="AI SUDOKU SOLVER", relief=GROOVE, font=("MS_Sans_Serif 18"), bg="lightgreen")
        self.titlelabel.grid(row=0, columnspan=4, sticky="ew")

        self.selimg = Button(self, text='Open image', command=self.open_img, relief=RAISED, fg="red", bg="orange",
                             borderwidth=3, padx=15)
        self.selimg.grid(row=1, column=0, padx=5, pady=5)
        self.imagepathdisplay = Entry(self, text="Path to image file", fg="gray", width=40, font=("MS_Sans_Serif 12"), borderwidth=3)
        ...
        self.img = ImageTk.PhotoImage(Image.open("defaultimg.jpg").resize((490, 450), Image.ANTIALIAS))
        ...
        self.mylink = Label(self, text="Aniruddhakj", borderwidth=3, relief=SUNKEN, fg="blue",
                            cursor="hand2")

        self.mylink.grid(row=5, columnspan=6, sticky="ew")
        self.mylink.bind("<Button-1>", lambda e: self.callback("https://github.com/aniruddhakj"))
...
class StagesFrame(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.stagesdict = {1: 'Initial Image', 2: 'Gaussian Blurring Image', 3: 'Adaptive Gaussian Thresholding',
                           4: 'Inverting', 5: 'Dilating to fill up cracks', 6: 'Floodfilling',
                           7: 'Parent Grid found!', 8: 'Eroding the grid a bit',
                           9: 'Using Hough Transform to find lines',
                           10: 'Finding the extreme lines',
                           11: 'Plotting the extreme line points on the original image',
        ...
        self.currentstage = 1
        self.mylink = Label(self, text="Aniruddhakj", borderwidth=3, relief=SUNKEN, fg="red",
                            cursor="hand2")
        ...
        self.img = ImageTk.PhotoImage(Image.open("defaultimg.jpg").resize((490, 490), Image.ANTIALIAS))
        self.imgpanel = Label(self, image=self.img)
    ...
    def back(self):
        ...
        if self.currentstage == 1:
            ...
            currstageimgpath = "PuzzleStages/" + str(self.currentstage - 1) + ".jpg"
...
class SudokuUI(Frame):
    ...
    def __init__(self, parent, controller, game):
        ...
        self.mylink = Label(self, text="Aniruddhakj", borderwidth=3, relief=SUNKEN, fg="yellow",
                            cursor="hand2")
        self.__draw_grid()
        self.__draw_puzzle()
